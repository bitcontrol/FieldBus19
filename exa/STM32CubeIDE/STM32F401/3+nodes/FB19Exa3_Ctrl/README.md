...
**Functionality:**
* If you push the push button PB1 on FB19 Subscriber1's NEB, LED1 on the FB19 Subscriber2's NEB will light up **(3)**
* If you push the push button PB1 on FB19 Subscriber2's NEB, LED1 on the FB19 Subscriber1's NEB will light up **(3)**
* In either case, LED1 on this node's NEB will light up **(3)**
